export function controlLoading(activate, spinner_text_container_id = "spinner-text", text = "Loading...") {
  var loading = document.getElementById("spinner-container");

  if(loading!=null){
    if(activate){
      document.getElementById(spinner_text_container_id).innerHTML = text;
