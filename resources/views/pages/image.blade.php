      ...
      <div class="row">
        <div class="col-md-6">
          <form>
            <div class="form-group">
              ...
              <textarea class="form-control" id="input_prompt" placeholder="¿Cuál es el concepto de la imagen a generar?" rows="3"></textarea>
        ...
        <div class="col-md-6">
          ...
          <div id="proposal_image_container">
            <img src="{{ asset('storage/images/image-generator-example.png') }}" alt="AI Generated Image">
          </div>
        </div>
      </div>
    </div>
